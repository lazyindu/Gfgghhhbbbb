...
@Client.on_message(filters.private & filters.regex(pattern=URL_REGEX) & ~filters.command(['thumbnail', 'caption']))
async def echo_http(bot: Client, update: Message):
    ...
    if e_response and "nonnumeric port" not in e_response:
        ...
        await bot.send_message(
            ...
            text=Script.NO_VOID_FORMAT_FOUND.format(
                str(error_message)),
    ...
    if t_response:
        ...
        # if thumbnail_image and not custom_thumbnail.get(update.from_user.id):
